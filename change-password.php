...
$email=$_SESSION['login'];
  $sql ="SELECT Password FROM lms_tblstudents WHERE EmailId=:email and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update lms_tblstudents set Password=:newpassword where EmailId=:email";
...
<head>
    ...
    <title>Online Library Management System | Cambio Password Studente</title>
